...
import { GameLevel } from "../../gameLevel/base/GameLevel";
...
export class QuestionResolverBase {
  ...
  async createQuestion(
    ...
    return await this.service.createQuestion({
      ...
      data: {
        ...
        gameLevel: args.data.gameLevel
          ? {
              connect: args.data.gameLevel,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => GameLevel, {
    nullable: true,
    name: "gameLevel",
  })
  async getGameLevel(
    ...
    const result = await this.service.getGameLevel(parent.id);
